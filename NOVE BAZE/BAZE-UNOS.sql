INSERT INTO vlasnik (`ID_vlasnik`, `ime`, `prezime`, `adresa`, `broj_telefona`, `username`, `password`) 
VALUES
...
INSERT INTO vozilo (`ID_vozilo`, `ID_vlasnik`, `marka`, `model`, `godina_proizvodnje`)
 VALUES
(1, 2, 'Audi', 'A3', '2015'),
(2, 4, 'BMW', 'X5', '2018'),
